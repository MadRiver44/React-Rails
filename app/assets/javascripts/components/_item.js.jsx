  ...
  render() {
    ...
    return (
      <div >
          {name}
          {description}
            <button className="buttons" onClick={this.props.handleDelete}>Delete</button>
            <button className="buttons" onClick={this.handleEdit}>{this.state.editable ? 'Submit' : 'Edit'}</button>
      </div>
      )
  }
});
